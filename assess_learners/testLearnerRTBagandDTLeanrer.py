...
if __name__ == "__main__":
    ...
    axi = []
    for i in range(40):
        learnerBag = dt.DTLearner(leaf_size=i + 1, verbose=False)
        learnerRT = bl.BagLearner(learner=rt.RTLearner, kwargs={"leaf_size": i + 1}, bags=60, boost=False, verbose=False)  # constructor
